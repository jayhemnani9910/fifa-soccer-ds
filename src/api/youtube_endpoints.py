...
async def start_youtube_analysis(
    request: YouTubeAnalysisRequest, background_tasks: BackgroundTasks
):
    """
    ...
    try:
        ...
        return AnalysisStatusResponse(task_id=task_id, status="pending", message="Analysis started")
...
async def download_results(task_id: str):
    ...
    return FileResponse(
        zip_path, media_type="application/zip", filename=f"youtube_analysis_{task_id}.zip"
    )
...
def format_analysis_results(
    results: dict[str, Any], task_id: str, output_dir: str
